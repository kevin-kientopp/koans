...
It was the worst of times.
	...
	num_new_lines = 3
    assert_equal "It was the best of times,".length + "It was the worst of times.".length + num_new_lines, long_string.length
...
EOS
	num_new_lines = 2
	assert_equal "It was the best of times,".length + "It was the worst of times.".length + num_new_lines, long_string.length
    assert_equal num_new_lines, long_string.lines.count
